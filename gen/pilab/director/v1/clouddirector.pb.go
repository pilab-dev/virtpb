...
import (
	virtpb "go.pilab.hu/cloud/virtpb"
...
func (x *AgentEventsRequest) GetHostStats() *virtpb.HostStats {
	if x != nil {
...
func (x *AgentEventsRequest) GetVmMetrics() *virtpb.VmMetrics {
	if x != nil {
...
func (x *AgentEventsRequest) GetJobStatus() *virtpb.JobStatus {
	if x != nil {
...
type AgentEventsRequest_HostStats struct {
	HostStats *virtpb.HostStats `protobuf:"bytes,4,opt,name=host_stats,json=hostStats,proto3,oneof"`
}

type AgentEventsRequest_VmMetrics struct {
	VmMetrics *virtpb.VmMetrics `protobuf:"bytes,5,opt,name=vm_metrics,json=vmMetrics,proto3,oneof"`
}

type AgentEventsRequest_JobStatus struct {
	JobStatus *virtpb.JobStatus `protobuf:"bytes,6,opt,name=job_status,json=jobStatus,proto3,oneof"`
}
...
const file_pilab_director_v1_clouddirector_proto_rawDesc = "" +
	...
	"\vAgentEvents\x12+.pilab.cloud.director.v1.AgentEventsRequest\x1a'.pilab.cloud.director.v1.ManagerMessage(\x010\x01B1Z/go.pilab.hu/cloud/virtpb/director/v1;directorv1b\x06proto3"
...
var file_pilab_director_v1_clouddirector_proto_goTypes = []any{
	...
	(*virtpb.HostStats)(nil),       // 13: pilab.cloud.HostStats
	(*virtpb.VmMetrics)(nil),       // 14: pilab.cloud.VmMetrics
	(*virtpb.JobStatus)(nil),       // 15: pilab.cloud.JobStatus
}
