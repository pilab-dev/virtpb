...
const file_pilab_agent_v1_storageservice_proto_rawDesc = "" +
	...
	"\x0eStoragePoolGet\x12+.pilab.cloud.agent.v1.StoragePoolGetRequest\x1a,.pilab.cloud.agent.v1.StoragePoolGetResponseB+Z)go.pilab.hu/cloud/virtpb/agent/v1;agentv1b\x06proto3"
