...
const (
	...
	VMState_VM_STATE_RUNNING     VMState = 1
	VMState_VM_STATE_BLOCKED     VMState = 2
	VMState_VM_STATE_PAUSED      VMState = 3
	VMState_VM_STATE_SHUTDOWN    VMState = 4
	VMState_VM_STATE_SHUTOFF     VMState = 5
	VMState_VM_STATE_CRASHED     VMState = 6
	VMState_VM_STATE_SUSPENDED   VMState = 7
)
...
const (
	HypervisorStatus_HEALTH_STATUS_UNSPECIFIED HypervisorStatus_HealthStatus = 0
	HypervisorStatus_HEALTH_STATUS_OK          HypervisorStatus_HealthStatus = 1
	HypervisorStatus_HEALTH_STATUS_WARNING     HypervisorStatus_HealthStatus = 2
	HypervisorStatus_HEALTH_STATUS_ERROR       HypervisorStatus_HealthStatus = 3
)
...
const (
	Event_SEVERITY_UNSPECIFIED Event_Severity = 0
	Event_SEVERITY_INFO        Event_Severity = 1
	Event_SEVERITY_WARNING     Event_Severity = 2
	Event_SEVERITY_ERROR       Event_Severity = 3
)
...
const (
	...
	LogRequest_LOG_LEVEL_WARNING     LogRequest_LogLevel = 3
...
const (
	TaskProgress_TASK_STATUS_UNSPECIFIED TaskProgress_TaskStatus = 0
	TaskProgress_TASK_STATUS_PENDING     TaskProgress_TaskStatus = 1
	TaskProgress_TASK_STATUS_RUNNING     TaskProgress_TaskStatus = 2
	TaskProgress_TASK_STATUS_COMPLETED   TaskProgress_TaskStatus = 3
	TaskProgress_TASK_STATUS_FAILED      TaskProgress_TaskStatus = 4
)
...
const (
	WorkflowState_STEP_STATE_UNSPECIFIED WorkflowState_StepState = 0
	WorkflowState_STEP_STATE_PENDING     WorkflowState_StepState = 1
	WorkflowState_STEP_STATE_RUNNING     WorkflowState_StepState = 2
	WorkflowState_STEP_STATE_SUCCEEDED   WorkflowState_StepState = 3
	WorkflowState_STEP_STATE_FAILED      WorkflowState_StepState = 4
)
...
const (
	AgentUpdateStatus_UPDATE_STATUS_UNSPECIFIED AgentUpdateStatus_UpdateStatus = 0
	AgentUpdateStatus_UPDATE_STATUS_DOWNLOADING AgentUpdateStatus_UpdateStatus = 1
	AgentUpdateStatus_UPDATE_STATUS_INSTALLING  AgentUpdateStatus_UpdateStatus = 2
	AgentUpdateStatus_UPDATE_STATUS_SUCCESSFUL  AgentUpdateStatus_UpdateStatus = 3
	AgentUpdateStatus_UPDATE_STATUS_FAILED      AgentUpdateStatus_UpdateStatus = 4
)
...
var (
	AgentUpdateStatus_UpdateStatus_name = map[int32]string{
		...
		2: "UPDATE_STATUS_INSTALLING",
		3: "UPDATE_STATUS_SUCCESSFUL",
...
func (x *HypervisorStatus) GetHealthStatus() HypervisorStatus_HealthStatus {
	...
	return HypervisorStatus_HEALTH_STATUS_UNSPECIFIED
}
...
func (x *Event) GetSeverity() Event_Severity {
	...
	return Event_SEVERITY_UNSPECIFIED
}
...
func (x *TaskProgress) GetStatus() TaskProgress_TaskStatus {
	...
	return TaskProgress_TASK_STATUS_UNSPECIFIED
}
...
func (x *WorkflowState) GetState() WorkflowState_StepState {
	...
	return WorkflowState_STEP_STATE_UNSPECIFIED
}
...
func (x *AgentUpdateStatus) GetStatus() AgentUpdateStatus_UpdateStatus {
	...
	return AgentUpdateStatus_UPDATE_STATUS_UNSPECIFIED
}
...
const file_pilab_agent_v1_agent_director_proto_rawDesc = "" +
	...
	" \x01(\x05R\n" +
	"stoppedVms\x12-\n" +
	"\x12hypervisor_version\x18\v \x01(\tR\x11hypervisorVersion\"w\n" +
	...
	"\x13HEALTH_STATUS_ERROR\x10\x03\"c\n" +
	...
	"\x19UPDATE_STATUS_DOWNLOADING\x10\x01\x12\x1c\n" +
	"\x18UPDATE_STATUS_INSTALLING\x10\x02\x12\x1c\n" +
	"\x18UPDATE_STATUS_SUCCESSFUL\x10\x03\x12\x18\n" +
	"\x14UPDATE_STATUS_FAILED\x10\x04\"5\n" +
	"\x12AgentConfiguration\x12\x1f\n" +
	"\vconfig_data\x18\x01 \x01(\tR\n" +
	"configData*\xbf\x01\n" +
	"\aVMState\x12\x18\n" +
	"\x14VM_STATE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10VM_STATE_RUNNING\x10\x01\x12\x14\n" +
	"\x10VM_STATE_BLOCKED\x10\x02\x12\x13\n" +
	...
	"\x1dAcknowledgeAgentConfiguration\x12(.pilab.cloud.agent.v1.AgentConfiguration\x1a\x16.google.protobuf.Empty\"\x00B+Z)go.pilab.hu/cloud/virtpb/agent/v1;agentv1b\x06proto3"
