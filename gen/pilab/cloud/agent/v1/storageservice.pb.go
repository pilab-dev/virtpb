...
const file_pilab_cloud_agent_v1_storageservice_proto_rawDesc = "" +
	"\n" +
	")pilab/cloud/agent/v1/storageservice.proto\x12\x14pilab.cloud.agent.v1\x1a!pilab/cloud/agent/v1/stream.proto\x1a'pilab/cloud/agent/v1/agentservice.proto\"~\n" +
	"\x06Volume\x12\x12\n" +
