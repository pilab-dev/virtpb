...
const file_pilab_cloud_agent_v1_storageservice_proto_rawDesc = "" +
	"\n" +
	")pilab/cloud/agent/v1/storageservice.proto\x12\x14pilab.cloud.agent.v1\x1a!pilab/cloud/agent/v1/stream.proto\x1a(pilab/cloud/agent/v1/agent_service.proto\x1a pilab/cloud/agent/v1/error.proto\"~\n" +
	"\x06Volume\x12\x12\n" +
	...
	"\x0eStoragePoolGet\x12+.pilab.cloud.agent.v1.StoragePoolGetRequest\x1a,.pilab.cloud.agent.v1.StoragePoolGetResponseB;Z9go.pilab.hu/cloud/pibase/gen/pilab/cloud/agent/v1;agentv1b\x06proto3"
