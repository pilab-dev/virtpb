...
func (PowerAction) Descriptor() protoreflect.EnumDescriptor {
	return file_pilab_cloud_agent_v1_vm_service_proto_enumTypes[1].Descriptor()
}

func (PowerAction) Type() protoreflect.EnumType {
	return &file_pilab_cloud_agent_v1_vm_service_proto_enumTypes[1]
}
...
func (RecurrenceType) Descriptor() protoreflect.EnumDescriptor {
	return file_pilab_cloud_agent_v1_vm_service_proto_enumTypes[2].Descriptor()
}

func (RecurrenceType) Type() protoreflect.EnumType {
	return &file_pilab_cloud_agent_v1_vm_service_proto_enumTypes[2]
}
...
type Firmware struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // e.g., "bios", "uefi"
...
type TPM struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Model         string                 `protobuf:"bytes,1,opt,name=model,proto3" json:"model,omitempty"`     // e.g., "tpm-tis", "tpm-crb"
	Backend       string                 `protobuf:"bytes,2,opt,name=backend,proto3" json:"backend,omitempty"` // e.g., "emulator", "passthrough"
	Device        string                 `protobuf:"bytes,3,opt,name=device,proto3" json:"device,omitempty"`   // for passthrough backend
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type USBController struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	Model                 string                 `protobuf:"bytes,1,opt,name=model,proto3" json:"model,omitempty"`                                                                 // e.g., "nec-xhci" (USB 3.0), "ehci" (USB 2.0), "qusb1" (USB 1.1), "qusb2" (USB 2.0)
	HostDevicePassthrough bool                   `protobuf:"varint,2,opt,name=host_device_passthrough,json=hostDevicePassthrough,proto3" json:"host_device_passthrough,omitempty"` // Enable host device passthrough
	PassthroughDevices    []string               `protobuf:"bytes,3,rep,name=passthrough_devices,json=passthroughDevices,proto3" json:"passthrough_devices,omitempty"`             // List of host USB devices to passthrough
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type USBDevice struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VendorId      string                 `protobuf:"bytes,1,opt,name=vendor_id,json=vendorId,proto3" json:"vendor_id,omitempty"`       // USB vendor ID (e.g., "0x0781" for SanDisk)
	ProductId     string                 `protobuf:"bytes,2,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`    // USB product ID
	HostBus       string                 `protobuf:"bytes,3,opt,name=host_bus,json=hostBus,proto3" json:"host_bus,omitempty"`          // Host bus number
	HostDevice    string                 `protobuf:"bytes,4,opt,name=host_device,json=hostDevice,proto3" json:"host_device,omitempty"` // Host device number
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VMNetworkInterface struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Type   string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`     // e.g., "bridge", "network"
	Source string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"` // bridge name or network name
	Model  string                 `protobuf:"bytes,3,opt,name=model,proto3" json:"model,omitempty"`   // e.g., "virtio", "e1000"
	Mac    string                 `protobuf:"bytes,4,opt,name=mac,proto3" json:"mac,omitempty"`       // MAC address
	// For bonding/teaming
	BondInterfaces []string `protobuf:"bytes,5,rep,name=bond_interfaces,json=bondInterfaces,proto3" json:"bond_interfaces,omitempty"` // interfaces to bond
	BondMode       string   `protobuf:"bytes,6,opt,name=bond_mode,json=bondMode,proto3" json:"bond_mode,omitempty"`                   // e.g., "active-backup", "balance-rr", "lacp"
	LacpEnabled    bool     `protobuf:"varint,7,opt,name=lacp_enabled,json=lacpEnabled,proto3" json:"lacp_enabled,omitempty"`
	// Wake-on-LAN support
	WakeOnLan     bool `protobuf:"varint,8,opt,name=wake_on_lan,json=wakeOnLan,proto3" json:"wake_on_lan,omitempty"` // Enable Wake-on-LAN for this interface
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VirtualMachine struct {
	...
	UsbDevices        []*USBDevice          `protobuf:"bytes,10,rep,name=usb_devices,json=usbDevices,proto3" json:"usb_devices,omitempty"` // USB devices to attach to the VM
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type WakeOnLANRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VmUuid        string                 `protobuf:"bytes,1,opt,name=vm_uuid,json=vmUuid,proto3" json:"vm_uuid,omitempty"`             // UUID of the VM to wake up
	MacAddress    string                 `protobuf:"bytes,2,opt,name=mac_address,json=macAddress,proto3" json:"mac_address,omitempty"` // MAC address to send magic packet to (optional, can be retrieved from VM config)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WakeOnLANResponse) Reset() {
	*x = WakeOnLANResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WakeOnLANResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{24}
}
...
func (x *UpdateVMRequest) Reset() {
	*x = UpdateVMRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateVMRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{25}
}
...
func (x *UpdateVMResponse) Reset() {
	*x = UpdateVMResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateVMResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{26}
}
...
func (x *VmGuestInfoRequest) Reset() {
	*x = VmGuestInfoRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VmGuestInfoRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{27}
}
...
func (x *VmGuestOS) Reset() {
	*x = VmGuestOS{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VmGuestOS) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{28}
}
...
func (x *VmGuestInterfaceAddress) Reset() {
	*x = VmGuestInterfaceAddress{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VmGuestInterfaceAddress) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{29}
}
...
func (x *VmGuestNetworkInterface) Reset() {
	*x = VmGuestNetworkInterface{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VmGuestNetworkInterface) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{30}
}
...
func (x *VmGuestInfoResponse) Reset() {
	*x = VmGuestInfoResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VmGuestInfoResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{31}
}
...
type PowerSchedule struct {
	...
	Time          string                 `protobuf:"bytes,8,opt,name=time,proto3" json:"time,omitempty"`                                  // Time of day in HH:MM format (local timezone)
...
func (x *PowerSchedule) Reset() {
	*x = PowerSchedule{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PowerSchedule) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{32}
}
...
type CreatePowerScheduleRequest struct {
	...
	Time          string                 `protobuf:"bytes,7,opt,name=time,proto3" json:"time,omitempty"`                                  // Required: HH:MM format
...
func (x *CreatePowerScheduleRequest) Reset() {
	*x = CreatePowerScheduleRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreatePowerScheduleRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{33}
}
...
func (x *CreatePowerScheduleResponse) Reset() {
	*x = CreatePowerScheduleResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreatePowerScheduleResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{34}
}
...
type ListPowerSchedulesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	VmUuid        string                 `protobuf:"bytes,1,opt,name=vm_uuid,json=vmUuid,proto3" json:"vm_uuid,omitempty"` // Optional: filter by VM
...
func (x *ListPowerSchedulesRequest) Reset() {
	*x = ListPowerSchedulesRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPowerSchedulesRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{35}
}
...
func (x *ListPowerSchedulesResponse) Reset() {
	*x = ListPowerSchedulesResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPowerSchedulesResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{36}
}
...
func (x *UpdatePowerScheduleRequest) Reset() {
	*x = UpdatePowerScheduleRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdatePowerScheduleRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{37}
}
...
func (x *UpdatePowerScheduleResponse) Reset() {
	*x = UpdatePowerScheduleResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdatePowerScheduleResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{38}
}
...
func (x *DeletePowerScheduleRequest) Reset() {
	*x = DeletePowerScheduleRequest{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeletePowerScheduleRequest) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{39}
}
...
func (x *DeletePowerScheduleResponse) Reset() {
	*x = DeletePowerScheduleResponse{}
	mi := &file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeletePowerScheduleResponse) Descriptor() ([]byte, []int) {
	return file_pilab_cloud_agent_v1_vm_service_proto_rawDescGZIP(), []int{40}
}
...
const file_pilab_cloud_agent_v1_vm_service_proto_rawDesc = "" +
	...
	"\x06device\x18\x03 \x01(\tR\x06device\"\x8e\x01\n" +
	...
	"\x13DeletePowerSchedule\x120.pilab.cloud.agent.v1.DeletePowerScheduleRequest\x1a1.pilab.cloud.agent.v1.DeletePowerScheduleResponseB;Z9go.pilab.hu/cloud/pibase/gen/pilab/cloud/agent/v1;agentv1b\x06proto3"
...
var file_pilab_cloud_agent_v1_vm_service_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_pilab_cloud_agent_v1_vm_service_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
func file_pilab_cloud_agent_v1_vm_service_proto_init() {
	...
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[19].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[20].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[24].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[26].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[34].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[36].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[37].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[38].OneofWrappers = []any{}
	file_pilab_cloud_agent_v1_vm_service_proto_msgTypes[40].OneofWrappers = []any{}
	type x struct{}
