...
const file_pilab_cloud_job_status_proto_rawDesc = "" +
	"\n" +
	"\x1cpilab/cloud/job_status.proto\x12\vpilab.cloud\"\xed\x01\n" +
	"\tJobStatus\x12\x10\n" +
	...
	"\b_messageB\n" +
	"\n" +
	"\b_host_idB2Z0go.pilab.hu/cloud/virtpb/gen/pilab/cloud;cloudpbb\x06proto3"
