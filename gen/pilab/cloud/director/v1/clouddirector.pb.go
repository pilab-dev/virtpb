...
const file_pilab_cloud_director_v1_clouddirector_proto_rawDesc = "" +
	"\n" +
	"+pilab/cloud/director/v1/clouddirector.proto\x12\x17pilab.cloud.director.v1\x1a\x1cpilab/cloud/vm_metrics.proto\x1a\x1cpilab/cloud/job_status.proto\x1a\x1cpilab/cloud/host_stats.proto\"6\n" +
	...
	"\x05event\x18\x02 \x01(\tR\x05event\"\x88\x01\n" +
	"\x0eManagerMessage\x12k\n" +
	"\x18resource_refresh_request\x18\x02 \x01(\v2/.pilab.cloud.director.v1.ResourceRefreshRequestH\x00R\x16resourceRefreshRequestB\t\n" +
	"\amessage\"\x18\n" +
	"\x16ResourceRefreshRequest\"\xa0\x05\n" +
