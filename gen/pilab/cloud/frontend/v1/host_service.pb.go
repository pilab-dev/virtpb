...
const file_pilab_cloud_frontend_v1_host_service_proto_rawDesc = "" +
	"\n" +
	"*pilab/cloud/frontend/v1/host_service.proto\x12\x17pilab.cloud.director.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9a\x05\n" +
	"\fHostOverview\x12\x1a\n" +
	"\bhostname\x18\x01 \x01(\tR\bhostname\x12\x12\n" +
	"\x04fqdn\x18\x02 \x01(\tR\x04fqdn\x12;\n" +
	"\x06status\x18\x03 \x01(\x0e2#.pilab.cloud.director.v1.HostStatusR\x06status\x122\n" +
	...
	"\vcpu_metrics\x18\b \x01(\v2#.pilab.cloud.director.v1.CPUMetricsR\n" +
	"cpuMetrics\x12M\n" +
	"\x0ememory_metrics\x18\t \x01(\v2&.pilab.cloud.director.v1.MemoryMetricsR\rmemoryMetrics\x12\x19\n" +
	"\bvm_count\x18\n" +
	" \x01(\x05R\avmCount\x12,\n" +
	"\x12active_alert_count\x18\v \x01(\x05R\x10activeAlertCount\x12G\n" +
	"\frecent_tasks\x18\f \x03(\v2$.pilab.cloud.director.v1.TaskSummaryR\vrecentTasks\x12c\n" +
	"\x13resource_allocation\x18\r \x01(\v22.pilab.cloud.director.v1.ResourceAllocationSummaryR\x12resourceAllocation\"1\n" +
	"\n" +
	"CPUMetrics\x12#\n" +
	...
	"\x03cpu\x18\x01 \x01(\v2&.pilab.cloud.director.v1.CPUAllocationR\x03cpu\x12A\n" +
	"\x06memory\x18\x02 \x01(\v2).pilab.cloud.director.v1.MemoryAllocationR\x06memory\x12D\n" +
	"\astorage\x18\x03 \x01(\v2*.pilab.cloud.director.v1.StorageAllocationR\astorage\"Y\n" +
	...
	"\vdata_points\x18\x01 \x03(\v2\".pilab.cloud.director.v1.DataPointR\n" +
	"dataPoints\"[\n" +
	"\tDataPoint\x128\n" +
	...
	"\x03vms\x18\x01 \x03(\v2\x1f.pilab.cloud.director.v1.VMInfoR\x03vms\"\xf5\x01\n" +
	"\x06VMInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x129\n" +
	"\x06status\x18\x03 \x01(\x0e2!.pilab.cloud.director.v1.VMStatusR\x06status\x12*\n" +
	...
	"\x10user_permissions\x18\x01 \x03(\v2!.pilab.cloud.director.v1.HostUserR\x0fuserPermissions\"y\n" +
	"\bHostUser\x12\x1a\n" +
	...
	"\n" +
	"datastores\x18\x01 \x03(\v2&.pilab.cloud.director.v1.DatastoreInfoR\n" +
	"datastores\"\xc5\x01\n" +
	"\rDatastoreInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12:\n" +
	"\x04type\x18\x02 \x01(\x0e2&.pilab.cloud.director.v1.DatastoreTypeR\x04type\x12\x1f\n" +
	...
	"\ageneral\x18\x01 \x01(\v2(.pilab.cloud.director.v1.GeneralSettingsR\ageneral\x129\n" +
	"\x04time\x18\x02 \x01(\v2%.pilab.cloud.director.v1.TimeSettingsR\x04time\x126\n" +
	"\x03dns\x18\x03 \x01(\v2$.pilab.cloud.director.v1.DNSSettingsR\x03dns\x12B\n" +
	"\arouting\x18\x04 \x01(\v2(.pilab.cloud.director.v1.RoutingSettingsR\arouting\"\xdc\x01\n" +
	...
	"\rstatic_routes\x18\x02 \x03(\v2$.pilab.cloud.director.v1.StaticRouteR\fstaticRoutes\"g\n" +
	"\vStaticRoute\x12 \n" +
	...
	"\n" +
	"interfaces\x18\x01 \x03(\v2-.pilab.cloud.director.v1.NetworkInterfaceInfoR\n" +
	"interfaces\"\x86\x02\n" +
	"\x14NetworkInterfaceInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12G\n" +
	"\x06status\x18\x02 \x01(\x0e2/.pilab.cloud.director.v1.NetworkInterfaceStatusR\x06status\x12\x1d\n" +
	"\n" +
	...
	"\bhostname\x18\x01 \x01(\tR\bhostname\"\xfa\x01\n" +
	"\x18GetMonitoringDataRequest\x12\x1a\n" +
	"\bhostname\x18\x01 \x01(\tR\bhostname\x12\x16\n" +
	"\x06metric\x18\x02 \x01(\tR\x06metric\x12\x1c\n" +
	"\tinterface\x18\x03 \x01(\tR\tinterface\x12\x1c\n" +
	"\tdatastore\x18\x04 \x01(\tR\tdatastore\x128\n" +
	"\tstartTime\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x124\n" +
	"\aendTime\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"0\n" +
	...
	"\rstatic_routes\x18\x03 \x03(\v2$.pilab.cloud.director.v1.StaticRouteR\fstaticRoutes\"Z\n" +
	...
	"\vHostService\x12i\n" +
	"\x0fGetHostOverview\x12/.pilab.cloud.director.v1.GetHostOverviewRequest\x1a%.pilab.cloud.director.v1.HostOverview\x12w\n" +
	"\x11GetMonitoringData\x121.pilab.cloud.director.v1.GetMonitoringDataRequest\x1a/.pilab.cloud.director.v1.MonitoringDataResponse\x12d\n" +
	"\vListHostVMs\x12+.pilab.cloud.director.v1.ListHostVMsRequest\x1a(.pilab.cloud.director.v1.HostVMsResponse\x12z\n" +
	"\x12GetHostPermissions\x122.pilab.cloud.director.v1.GetHostPermissionsRequest\x1a0.pilab.cloud.director.v1.HostPermissionsResponse\x12y\n" +
	"\x12ListHostDatastores\x122.pilab.cloud.director.v1.ListHostDatastoresRequest\x1a/.pilab.cloud.director.v1.HostDatastoresResponse\x12q\n" +
	"\x0eMountDatastore\x12..pilab.cloud.director.v1.MountDatastoreRequest\x1a/.pilab.cloud.director.v1.MountDatastoreResponse\x12w\n" +
	"\x10UnmountDatastore\x120.pilab.cloud.director.v1.UnmountDatastoreRequest\x1a1.pilab.cloud.director.v1.UnmountDatastoreResponse\x12\x83\x01\n" +
	"\x15GetHostSystemSettings\x125.pilab.cloud.director.v1.GetHostSystemSettingsRequest\x1a3.pilab.cloud.director.v1.HostSystemSettingsResponse\x12t\n" +
	"\x0fUpdateNTPConfig\x12/.pilab.cloud.director.v1.UpdateNTPConfigRequest\x1a0.pilab.cloud.director.v1.UpdateNTPConfigResponse\x12q\n" +
	"\x0eUpdateTimezone\x12..pilab.cloud.director.v1.UpdateTimezoneRequest\x1a/.pilab.cloud.director.v1.UpdateTimezoneResponse\x12z\n" +
	"\x11UpdateDNSSettings\x121.pilab.cloud.director.v1.UpdateDNSSettingsRequest\x1a2.pilab.cloud.director.v1.UpdateDNSSettingsResponse\x12\x86\x01\n" +
	"\x15UpdateRoutingSettings\x125.pilab.cloud.director.v1.UpdateRoutingSettingsRequest\x1a6.pilab.cloud.director.v1.UpdateRoutingSettingsResponse\x12\x8c\x01\n" +
	"\x18GetMaintenanceModeStatus\x128.pilab.cloud.director.v1.GetMaintenanceModeStatusRequest\x1a6.pilab.cloud.director.v1.MaintenanceModeStatusResponse\x12\x83\x01\n" +
	"\x14EnterMaintenanceMode\x124.pilab.cloud.director.v1.EnterMaintenanceModeRequest\x1a5.pilab.cloud.director.v1.EnterMaintenanceModeResponse\x12\x80\x01\n" +
	"\x13ExitMaintenanceMode\x123.pilab.cloud.director.v1.ExitMaintenanceModeRequest\x1a4.pilab.cloud.director.v1.ExitMaintenanceModeResponse\x12\x8e\x01\n" +
	"\x19ListHostNetworkInterfaces\x129.pilab.cloud.director.v1.ListHostNetworkInterfacesRequest\x1a6.pilab.cloud.director.v1.HostNetworkInterfacesResponse\x12\x89\x01\n" +
	"\x16EnableNetworkInterface\x126.pilab.cloud.director.v1.EnableNetworkInterfaceRequest\x1a7.pilab.cloud.director.v1.EnableNetworkInterfaceResponse\x12\x8c\x01\n" +
	"\x17DisableNetworkInterface\x127.pilab.cloud.director.v1.DisableNetworkInterfaceRequest\x1a8.pilab.cloud.director.v1.DisableNetworkInterfaceResponseBAZ?go.pilab.hu/cloud/virtpb/gen/pilab/cloud/frontend/v1;frontendv1b\x06proto3"
