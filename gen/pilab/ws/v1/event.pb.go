...
type JobList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Jobs          []*virtpb.JobStatus    `protobuf:"bytes,1,rep,name=jobs,proto3" json:"jobs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JobList) GetJobs() []*virtpb.JobStatus {
	if x != nil {
		return x.Jobs
	}
	return nil
...
func (x *Event) GetJobStatus() *virtpb.JobStatus {
	if x != nil {
...
func (x *Event) GetHostStatsEvent() *virtpb.HostStats {
	if x != nil {
...
func (x *Event) GetVmMetrics() *virtpb.VmMetrics {
	if x != nil {
...
type Event_JobStatus struct {
	JobStatus *virtpb.JobStatus `protobuf:"bytes,1,opt,name=job_status,json=jobStatus,proto3,oneof"`
}
...
type Event_HostStatsEvent struct {
	HostStatsEvent *virtpb.HostStats `protobuf:"bytes,6,opt,name=host_stats_event,json=hostStatsEvent,proto3,oneof"`
}

type Event_VmMetrics struct {
	VmMetrics *virtpb.VmMetrics `protobuf:"bytes,7,opt,name=vm_metrics,json=vmMetrics,proto3,oneof"`
}
...
const file_pilab_ws_v1_event_proto_rawDesc = "" +
	...
	"\apayloadB%Z#go.pilab.hu/cloud/virtpb/ws/v1;wsv1b\x06proto3"
...
var file_pilab_ws_v1_event_proto_goTypes = []any{
	...
	(*virtpb.JobStatus)(nil),    // 10: pilab.cloud.JobStatus
	(*virtpb.HostStats)(nil),    // 11: pilab.cloud.HostStats
	(*virtpb.VmMetrics)(nil),    // 12: pilab.cloud.VmMetrics
}
