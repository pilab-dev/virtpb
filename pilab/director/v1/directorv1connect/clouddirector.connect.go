...
import (
	...
	context "context"
	errors "errors"
	v1 "go.pilab.hu/cloud/virtpb/director/v1"
	http "net/http"
	strings "strings"
)
...
func NewCloudDirectorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CloudDirectorServiceClient {
	...
	cloudDirectorServiceMethods := v1.File_pilab_director_v1_clouddirector_proto.Services().ByName("CloudDirectorService").Methods()
