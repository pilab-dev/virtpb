...
const (
	...
	AgentService_ExportOVA_FullMethodName                = "/pilab.cloud.agent.v2.AgentService/ExportOVA"
	AgentService_ImportOVA_FullMethodName                = "/pilab.cloud.agent.v2.AgentService/ImportOVA"
	...
	AgentService_GetVMGuestIPs_FullMethodName            = "/pilab.cloud.agent.v2.AgentService/GetVMGuestIPs"
	AgentService_ChangeVMUserPassword_FullMethodName     = "/pilab.cloud.agent.v2.AgentService/ChangeVMUserPassword"
	AgentService_AttachCloudInit_FullMethodName          = "/pilab.cloud.agent.v2.AgentService/AttachCloudInit"
	AgentService_AttachNetworkInterface_FullMethodName   = "/pilab.cloud.agent.v2.AgentService/AttachNetworkInterface"
	AgentService_DetachNetworkInterface_FullMethodName   = "/pilab.cloud.agent.v2.AgentService/DetachNetworkInterface"
	AgentService_Stream_FullMethodName                   = "/pilab.cloud.agent.v2.AgentService/Stream"
	AgentService_GetHardwareHealth_FullMethodName        = "/pilab.cloud.agent.v2.AgentService/GetHardwareHealth"
	AgentService_GetSensorData_FullMethodName            = "/pilab.cloud.agent.v2.AgentService/GetSensorData"
	AgentService_DefineVM_FullMethodName                 = "/pilab.cloud.agent.v2.AgentService/DefineVM"
	AgentService_GetVMDefinition_FullMethodName          = "/pilab.cloud.agent.v2.AgentService/GetVMDefinition"
	AgentService_ControlVM_FullMethodName                = "/pilab.cloud.agent.v2.AgentService/ControlVM"
	AgentService_GetVMStatus_FullMethodName              = "/pilab.cloud.agent.v2.AgentService/GetVMStatus"
	AgentService_GetVMGuestInfo_FullMethodName           = "/pilab.cloud.agent.v2.AgentService/GetVMGuestInfo"
	AgentService_CreatePowerSchedule_FullMethodName      = "/pilab.cloud.agent.v2.AgentService/CreatePowerSchedule"
	AgentService_ListPowerSchedules_FullMethodName       = "/pilab.cloud.agent.v2.AgentService/ListPowerSchedules"
	AgentService_UpdatePowerSchedule_FullMethodName      = "/pilab.cloud.agent.v2.AgentService/UpdatePowerSchedule"
	AgentService_DeletePowerSchedule_FullMethodName      = "/pilab.cloud.agent.v2.AgentService/DeletePowerSchedule"
	AgentService_WakeOnLAN_FullMethodName                = "/pilab.cloud.agent.v2.AgentService/WakeOnLAN"
)
