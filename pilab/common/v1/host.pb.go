...
type HostStats struct {
	...
	CpuUsage      float32                `protobuf:"fixed32,1,opt,name=cpu_usage,json=cpuUsage,proto3" json:"cpu_usage,omitempty"`         // CPU utilization (0.0-100.0)
	DiskUsage     float32                `protobuf:"fixed32,2,opt,name=disk_usage,json=diskUsage,proto3" json:"disk_usage,omitempty"`      // Disk utilization (0.0-100.0)
	UsedMemory    uint64                 `protobuf:"varint,3,opt,name=used_memory,json=usedMemory,proto3" json:"used_memory,omitempty"`    // Used memory in bytes
	TotalMemory   uint64                 `protobuf:"varint,4,opt,name=total_memory,json=totalMemory,proto3" json:"total_memory,omitempty"` // Total memory in bytes
...
type VmMetrics struct {
	...
	// CPU metrics
	CpuUsage uint32 `protobuf:"varint,3,opt,name=cpu_usage,json=cpuUsage,proto3" json:"cpu_usage,omitempty"` // CPU usage percentage
	// Disk I/O metrics
	DiskRd    uint32 `protobuf:"varint,4,opt,name=disk_rd,json=diskRd,proto3" json:"disk_rd,omitempty"`            // Bytes read
	DiskRdReq uint32 `protobuf:"varint,5,opt,name=disk_rd_req,json=diskRdReq,proto3" json:"disk_rd_req,omitempty"` // Read requests
	DiskWr    uint32 `protobuf:"varint,6,opt,name=disk_wr,json=diskWr,proto3" json:"disk_wr,omitempty"`            // Bytes written
	DiskWrReq uint64 `protobuf:"varint,7,opt,name=disk_wr_req,json=diskWrReq,proto3" json:"disk_wr_req,omitempty"` // Write requests
	// Network I/O metrics
	NetworkRxBytes uint32 `protobuf:"varint,8,opt,name=network_rx_bytes,json=networkRxBytes,proto3" json:"network_rx_bytes,omitempty"`  // Bytes received
	NetworkRxPkt   uint32 `protobuf:"varint,9,opt,name=network_rx_pkt,json=networkRxPkt,proto3" json:"network_rx_pkt,omitempty"`        // Packets received
	NetworkTxBytes uint32 `protobuf:"varint,10,opt,name=network_tx_bytes,json=networkTxBytes,proto3" json:"network_tx_bytes,omitempty"` // Bytes transmitted
	NetworkTxPkt   uint32 `protobuf:"varint,11,opt,name=network_tx_pkt,json=networkTxPkt,proto3" json:"network_tx_pkt,omitempty"`       // Packets transmitted
	// Memory metrics
	MemoryUsage   uint32 `protobuf:"varint,12,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"` // Memory used (MB)
	MemoryTotal   uint32 `protobuf:"varint,13,opt,name=memory_total,json=memoryTotal,proto3" json:"memory_total,omitempty"` // Total memory (MB)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CPUMetrics struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UsagePercent  float64                `protobuf:"fixed64,1,opt,name=usage_percent,json=usagePercent,proto3" json:"usage_percent,omitempty"` // CPU usage percentage
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MemoryMetrics struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UsagePercent  float64                `protobuf:"fixed64,1,opt,name=usage_percent,json=usagePercent,proto3" json:"usage_percent,omitempty"` // Memory usage percentage
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type StorageMetrics struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TotalGb       int64                  `protobuf:"varint,1,opt,name=total_gb,json=totalGb,proto3" json:"total_gb,omitempty"` // Total storage in GB
	UsedGb        int64                  `protobuf:"varint,2,opt,name=used_gb,json=usedGb,proto3" json:"used_gb,omitempty"`    // Used storage in GB
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DataPoint struct {
	...
	Unit          string                 `protobuf:"bytes,3,opt,name=unit,proto3" json:"unit,omitempty"`     // Unit of measurement
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SensorData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`                               // Sensor name (e.g., "CPU Temp")
	Value         float64                `protobuf:"fixed64,2,opt,name=value,proto3" json:"value,omitempty"`                           // Sensor reading
	Unit          string                 `protobuf:"bytes,3,opt,name=unit,proto3" json:"unit,omitempty"`                               // Unit (C, V, RPM, etc.)
	Status        string                 `protobuf:"bytes,4,opt,name=status,proto3" json:"status,omitempty"`                           // Status (ok, warning, critical)
	SensorType    string                 `protobuf:"bytes,5,opt,name=sensor_type,json=sensorType,proto3" json:"sensor_type,omitempty"` // Type (temperature, voltage, fan)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type HardwareHealth struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	OverallStatus   string                 `protobuf:"bytes,1,opt,name=overall_status,json=overallStatus,proto3" json:"overall_status,omitempty"` // overall status (ok, degraded, failed)
...
type NetworkStats struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Interface     string                 `protobuf:"bytes,1,opt,name=interface,proto3" json:"interface,omitempty"`                   // Interface name
	RxBytes       int64                  `protobuf:"varint,2,opt,name=rx_bytes,json=rxBytes,proto3" json:"rx_bytes,omitempty"`       // Received bytes
	TxBytes       int64                  `protobuf:"varint,3,opt,name=tx_bytes,json=txBytes,proto3" json:"tx_bytes,omitempty"`       // Transmitted bytes
	RxPackets     int64                  `protobuf:"varint,4,opt,name=rx_packets,json=rxPackets,proto3" json:"rx_packets,omitempty"` // Received packets
	TxPackets     int64                  `protobuf:"varint,5,opt,name=tx_packets,json=txPackets,proto3" json:"tx_packets,omitempty"` // Transmitted packets
	RxErrors      int64                  `protobuf:"varint,6,opt,name=rx_errors,json=rxErrors,proto3" json:"rx_errors,omitempty"`    // Receive errors
	TxErrors      int64                  `protobuf:"varint,7,opt,name=tx_errors,json=txErrors,proto3" json:"tx_errors,omitempty"`    // Transmit errors
	RxDrops       int64                  `protobuf:"varint,8,opt,name=rx_drops,json=rxDrops,proto3" json:"rx_drops,omitempty"`       // Receive drops
	TxDrops       int64                  `protobuf:"varint,9,opt,name=tx_drops,json=txDrops,proto3" json:"tx_drops,omitempty"`       // Transmit drops
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
