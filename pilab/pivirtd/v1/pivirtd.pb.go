...
const file_pilab_pivirtd_v1_pivirtd_proto_rawDesc = "" +
	...
	"\n" +
	"cpu_shares\x18\x03 \x01(\x03R\tcpuShares\"\xed\x01\n" +
	...
	"\avlan_id\x18\a \x01(\x05R\x06vlanId\"W\n" +
	"\x15CreateNetworkResponse\x12>\n" +
	"\anetwork\x18\x01 \x01(\v2$.pilab.virtualization.v1.NetworkInfoR\anetwork\"\xcb\x01\n" +
	...
	"\tstatic_ip\x18\x03 \x01(\tR\bstaticIp\"~\n" +
	"\x19AttachVMToNetworkResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12G\n" +
	"\fnetwork_info\x18\x02 \x01(\v2$.pilab.virtualization.v1.NetworkInfoR\vnetworkInfo*\x9d\x04\n" +
...
var file_pilab_pivirtd_v1_pivirtd_proto_goTypes = []any{
	...
	(*CreateNetworkRequest)(nil),      // 80: pilab.virtualization.v1.CreateNetworkRequest
	(*CreateNetworkResponse)(nil),     // 81: pilab.virtualization.v1.CreateNetworkResponse
	(*NetworkInfo)(nil),               // 82: pilab.virtualization.v1.NetworkInfo
	(*AttachVMToNetworkRequest)(nil),  // 83: pilab.virtualization.v1.AttachVMToNetworkRequest
	(*AttachVMToNetworkResponse)(nil), // 84: pilab.virtualization.v1.AttachVMToNetworkResponse
...
var file_pilab_pivirtd_v1_pivirtd_proto_depIdxs = []int32{
	...
	86, // 37: pilab.virtualization.v1.HostEvent.timestamp:type_name -> google.protobuf.Timestamp
	...
	82, // 44: pilab.virtualization.v1.CreateNetworkResponse.network:type_name -> pilab.virtualization.v1.NetworkInfo
	82, // 45: pilab.virtualization.v1.AttachVMToNetworkResponse.network_info:type_name -> pilab.virtualization.v1.NetworkInfo
	...
	71, // 79: pilab.virtualization.v1.PivirtdService.SubscribeEvents:input_type -> pilab.virtualization.v1.SubscribeEventsRequest
	71, // 80: pilab.virtualization.v1.PivirtdService.GetHostResource:input_type -> pilab.virtualization.v1.SubscribeEventsRequest
	10, // 81: pilab.virtualization.v1.PivirtdService.CreateVM:output_type -> pilab.virtualization.v1.VMResponse
	10, // 82: pilab.virtualization.v1.PivirtdService.StartVM:output_type -> pilab.virtualization.v1.VMResponse
	10, // 83: pilab.virtualization.v1.PivirtdService.StopVM:output_type -> pilab.virtualization.v1.VMResponse
	10, // 84: pilab.virtualization.v1.PivirtdService.PauseVM:output_type -> pilab.virtualization.v1.VMResponse
	10, // 85: pilab.virtualization.v1.PivirtdService.ResumeVM:output_type -> pilab.virtualization.v1.VMResponse
	10, // 86: pilab.virtualization.v1.PivirtdService.RebootVM:output_type -> pilab.virtualization.v1.VMResponse
	11, // 87: pilab.virtualization.v1.PivirtdService.DeleteVM:output_type -> pilab.virtualization.v1.DeleteVMResponse
	12, // 88: pilab.virtualization.v1.PivirtdService.ListVMs:output_type -> pilab.virtualization.v1.ListVMsResponse
	10, // 89: pilab.virtualization.v1.PivirtdService.GetVM:output_type -> pilab.virtualization.v1.VMResponse
	19, // 90: pilab.virtualization.v1.PivirtdService.GetVMStats:output_type -> pilab.virtualization.v1.VMStatsResponse
	25, // 91: pilab.virtualization.v1.PivirtdService.ExecuteQMP:output_type -> pilab.virtualization.v1.ExecuteQMPResponse
	27, // 92: pilab.virtualization.v1.PivirtdService.StreamQMPEvents:output_type -> pilab.virtualization.v1.QMPEvent
	33, // 93: pilab.virtualization.v1.PivirtdService.CreateSnapshot:output_type -> pilab.virtualization.v1.SnapshotResponse
	30, // 94: pilab.virtualization.v1.PivirtdService.ListSnapshots:output_type -> pilab.virtualization.v1.ListSnapshotsResponse
	33, // 95: pilab.virtualization.v1.PivirtdService.RestoreSnapshot:output_type -> pilab.virtualization.v1.SnapshotResponse
	34, // 96: pilab.virtualization.v1.PivirtdService.DeleteSnapshot:output_type -> pilab.virtualization.v1.DeleteSnapshotResponse
	37, // 97: pilab.virtualization.v1.PivirtdService.MigrateVM:output_type -> pilab.virtualization.v1.MigrateVMResponse
	39, // 98: pilab.virtualization.v1.PivirtdService.GetMigrationStatus:output_type -> pilab.virtualization.v1.MigrationStatusResponse
	41, // 99: pilab.virtualization.v1.PivirtdService.CreateStoragePool:output_type -> pilab.virtualization.v1.StoragePoolResponse
	43, // 100: pilab.virtualization.v1.PivirtdService.ListStoragePools:output_type -> pilab.virtualization.v1.ListStoragePoolsResponse
	45, // 101: pilab.virtualization.v1.PivirtdService.DeleteStoragePool:output_type -> pilab.virtualization.v1.DeleteStoragePoolResponse
	49, // 102: pilab.virtualization.v1.PivirtdService.CreateTAPDevice:output_type -> pilab.virtualization.v1.NetworkResponse
	56, // 103: pilab.virtualization.v1.PivirtdService.DeleteTAPDevice:output_type -> pilab.virtualization.v1.DeleteNetworkResponse
	51, // 104: pilab.virtualization.v1.PivirtdService.ListTAPDevices:output_type -> pilab.virtualization.v1.ListTAPDevicesResponse
	49, // 105: pilab.virtualization.v1.PivirtdService.CreateBridge:output_type -> pilab.virtualization.v1.NetworkResponse
	56, // 106: pilab.virtualization.v1.PivirtdService.DeleteBridge:output_type -> pilab.virtualization.v1.DeleteNetworkResponse
	53, // 107: pilab.virtualization.v1.PivirtdService.ListBridges:output_type -> pilab.virtualization.v1.ListBridgesResponse
	49, // 108: pilab.virtualization.v1.PivirtdService.CreateOVSBridge:output_type -> pilab.virtualization.v1.NetworkResponse
	56, // 109: pilab.virtualization.v1.PivirtdService.DeleteOVSBridge:output_type -> pilab.virtualization.v1.DeleteNetworkResponse
	63, // 110: pilab.virtualization.v1.PivirtdService.ListOVSBridges:output_type -> pilab.virtualization.v1.ListOVSBridgesResponse
	49, // 111: pilab.virtualization.v1.PivirtdService.AddOVSPort:output_type -> pilab.virtualization.v1.NetworkResponse
	56, // 112: pilab.virtualization.v1.PivirtdService.RemoveOVSPort:output_type -> pilab.virtualization.v1.DeleteNetworkResponse
	67, // 113: pilab.virtualization.v1.PivirtdService.ListOVSPorts:output_type -> pilab.virtualization.v1.ListOVSPortsResponse
	72, // 114: pilab.virtualization.v1.PivirtdService.SubscribeEvents:output_type -> pilab.virtualization.v1.HostEvent
	76, // 115: pilab.virtualization.v1.PivirtdService.GetHostResource:output_type -> pilab.virtualization.v1.HostResourceReport
