...
import (
	...
	context "context"
	errors "errors"
	v1 "go.pilab.hu/cloud/virtpb/frontend/v1"
...
func NewManagementServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ManagementServiceClient {
	...
	managementServiceMethods := v1.File_pilab_frontend_v1_management_service_proto.Services().ByName("ManagementService").Methods()
